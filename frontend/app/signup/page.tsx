...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    // Connect to Laravel Sanctum registration API
    setTimeout(() => {
      setLoading(false);
    }, 1200);
  };
        ...
        <section className="relative hidden overflow-hidden bg-slate-950 lg:col-span-7 lg:flex lg:flex-col lg:justify-between p-12 xl:p-16 border-r border-slate-800/60">
          ...
          <div className="relative z-10 my-auto max-w-xl py-12">
            ...
            <h1 className="text-5xl font-extrabold leading-[1.08] tracking-tight text-white xl:text-6xl">
              Launch your career into <span className="bg-gradient-to-r from-cyan-400 via-sky-300 to-indigo-400 bg-clip-text text-transparent">high orbit.</span>
            </h1>

            <p className="mt-6 text-lg leading-relaxed text-slate-400">
              Create an account to build your AI profile, match directly with top engineering teams, and automate your job search pipeline.
            </p>
            ...
            <div className="mt-8 space-y-4">
              <div className="flex items-center gap-3 text-sm font-medium text-slate-300">
                ...
                Smart resume extraction & automated skill matching
              </div>
              <div className="flex items-center gap-3 text-sm font-medium text-slate-300">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-cyan-500/10 text-cyan-400 border border-cyan-500/20">
                  ✓
                </span>
                Direct contact from hiring managers without recruiters
              </div>
              <div className="flex items-center gap-3 text-sm font-medium text-slate-300">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-cyan-500/10 text-cyan-400 border border-cyan-500/20">
                  ✓
                </span>
                Real-time salary benchmarking & application tracking
              </div>
            </div>
          </div>
            ...
            <div className="rounded-3xl border border-slate-800 bg-slate-900/40 p-8 shadow-2xl backdrop-blur-xl sm:p-10">
              ...
              <header>
                ...
                <p className="mt-2 text-sm leading-relaxed text-slate-400">
                  Join Orbithire today to unlock personalized opportunities.
                </p>
              </header>

              {/* Account Role Selector */}
              <div className="mt-6 grid grid-cols-2 gap-2 rounded-xl bg-slate-950/80 p-1 border border-slate-800">
                <button
                  type="button"
              ...
              <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="h-11 w-full rounded-xl border border-slate-800 bg-slate-950/80 px-4 text-sm text-slate-100 placeholder-slate-500 outline-none transition duration-200 focus:border-cyan-500 focus:bg-slate-950 focus:ring-2 focus:ring-cyan-500/20"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="h-11 w-full rounded-xl border border-slate-800 bg-slate-950/80 px-4 pr-20 text-sm text-slate-100 placeholder-slate-500 outline-none transition duration-200 focus:border-cyan-500 focus:bg-slate-950 focus:ring-2 focus:ring-cyan-500/20"
                    />
                ...
                <div className="pt-2">
                  <label className="flex items-start gap-3 text-xs text-slate-400 cursor-pointer select-none">
                    <input
                      type="checkbox"
                      required
                      className="mt-0.5 h-4 w-4 rounded border-slate-800 bg-slate-950 text-cyan-500 focus:ring-cyan-500/20 focus:ring-offset-0"
                    />
                    <span>
                      I agree to the{" "}
              ...
              <button
                type="button"
                className="flex h-11 w-full items-center justify-center gap-3 rounded-xl border border-slate-800 bg-slate-950/60 text-sm font-semibold text-slate-200 transition duration-200 hover:border-slate-700 hover:bg-slate-900"
              >
